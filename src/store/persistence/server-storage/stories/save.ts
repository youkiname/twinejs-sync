...
import {addUnique, remove} from '../../local-storage/comma-list';
...
export function saveStory(transaction: StorageTransaction, story: Story) {
	...
	fetchApi('/save/story', {
		method: "POST",
		body: JSON.stringify({ ...story, passages: undefined }),
	})
...
export function deletePassageById(
	...
	fetchApi(`/delete/passage/${passageId}`, {
		method: "DELETE",
	})
